...
export const Dropdown: React.FC<DropdownProps | DropdownWithGroupsProps> = ({
                                                                                title = 'Options',
                                                                                ...props
                                                                            }) => {
    ...
    return (
        <Menu as="div" className="relative inline-block text-left">
            <div>
                <Menu.Button
                    className="inline-flex w-full justify-center rounded-lg bg-black bg-opacity-20 px-4 py-2 text-sm text-white hover:bg-opacity-30 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75"
                >
                    {title}
                    <BsChevronDown
            ...
            >
                <Menu.Items
                    className="z-10 rounded-xl absolute right-0 mt-2 w-56 origin-top-right divide-y divide-gray-200  bg-white ring-2 ring-black/5 focus:outline-none"
                >
                    {/* Iterate groups */}
